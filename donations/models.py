...
#
#     def __str__(self):
#         return f"{self.donation_type} - {self.donation_category} - {self.target_amount}"
#
#     def clean(self):
...
#                 if self.target_amount != self.event_option.target_amount:
...
#
#     def __str__(self):
#         return f"{self.event} - {self.donation_category} : {self.target_amount}"
#
