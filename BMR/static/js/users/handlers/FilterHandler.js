// static/js/users/handlers/FilterHandler.js
export class FilterHandler {
    ...
    setupEventListeners() {
        ...
        // Filter dropdowns
        [
            { element: this.elements.staffFilter, key: 'is_staff' },
            { element: this.elements.verifiedFilter, key: 'is_verified' },
    ...
    clearAllFilters() {
        ...
        if (this.elements.staffFilter) this.elements.staffFilter.value = '';
        if (this.elements.verifiedFilter) this.elements.verifiedFilter.value = '';
        if (this.elements.orderingSelect) this.elements.orderingSelect.value = '-date_joined';
